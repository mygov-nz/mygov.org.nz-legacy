        ...
        <div className="card form-card">
          <form className="row">
            <label className="col-sm-12 col-md-8 col-xl form-group" htmlFor="year">
              ...
              <select className="custom-select" id="year" name="year" required value={this.props.params.year}>
            ...
            <label className="col-sm-6 col-md-4 col-xl form-group" htmlFor="threshold">
              ...
              <div className="input-group">
                <input className="form-control" type="number" id="threshold" name="threshold" max="100" min="0" step="1" required value={this.props.params.threshold} />
            ...
            <label className="col-sm-6 col-md-4 col-xl form-group custom-control custom-checkbox" htmlFor="overhang">
              ...
              <input type="checkbox" className="custom-control-input" id="overhang" name="overhang" value="on" checked={this.props.params.overhang} />
            ...
            <label className="col-sm-6 col-md-4 col-xl form-group custom-control custom-checkbox" htmlFor="tagAlong">
              ...
              <input type="checkbox" className="custom-control-input" id="tagAlong" name="tagAlong" value="on" checked={this.props.params.tagAlong} />
              <span className="custom-control-indicator"></span>
            </label>
            <label className="col-sm-6 col-md-4 col-xl form-group" htmlFor="tagAlongSeats">
              ...
              <input className="form-control" type="number" id="tagAlongSeats" name="tagAlongSeats" max="120" min="1" step="1" required value={this.props.params.tagAlongSeats} />
            </label>
          </form>
        </div>
